...
- QEMU browser Pause interrupts active TCG execution and parks MTTCG vCPUs outside the Big QEMU Lock on an aligned Emscripten futex word; Resume wakes that word directly.
