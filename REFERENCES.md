...
- [Emscripten 3.1.50 threading API](https://github.com/emscripten-core/emscripten/blob/3.1.50/system/include/emscripten/threading.h) — `emscripten_thread_sleep()` provides synchronous worker sleeping without Asyncify suspension and keeps Emscripten's queued-call processing active while the vCPU is parked.
