...
- [Emscripten setjmp-longjmp support](https://emscripten.org/docs/porting/setjmp-longjmp.html) — WebAssembly exception handling keeps QEMU's `setjmp`/`longjmp` control transfers inside Wasm instead of routing them through JavaScript exceptions.
