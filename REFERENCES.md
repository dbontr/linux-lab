...
- [QEMU TCG CPU execution loop](https://github.com/ktock/qemu-wasm/blob/0ef7b4e2814b231705d8371dd7997f5b72e70baf/accel/tcg/cpu-exec.c) — the normal translation-block loop provides the blocking pause point after a generated chain has returned without requiring an asynchronous CPU exit.
- [qemu-wasm generated-TB backend](https://github.com/ktock/qemu-wasm/blob/0ef7b4e2814b231705d8371dd7997f5b72e70baf/tcg/wasm32/tcg-target.c.inc) — direct and indirect generated-TB chaining paths are guarded by the shared pause word so a Pause request returns through the normal backend boundary before the next guest block executes.
