...
- [Emscripten 3.1.50 atomic API](https://github.com/emscripten-core/emscripten/blob/3.1.50/system/include/emscripten/atomic.h) — worker-side wait and notify primitives used by the QEMU dispatcher pause boundary.
