...
- [qemu-wasm Wasm/TCI dispatcher](https://github.com/ktock/qemu-wasm/blob/0ef7b4e2814b231705d8371dd7997f5b72e70baf/tcg/wasm32.c) — cold-TB TCI direct and indirect chaining paths return cooperatively when the shared pause word is set.
- [qemu-wasm generated-TB backend](https://github.com/ktock/qemu-wasm/blob/0ef7b4e2814b231705d8371dd7997f5b72e70baf/tcg/wasm32/tcg-target.c.inc) — compiled direct and indirect generated-TB chaining paths are guarded by the same shared pause word so a Pause request returns through the normal backend boundary before the next guest block executes.
