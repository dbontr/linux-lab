...
- [Emscripten 3.1.50 atomic API](https://github.com/emscripten-core/emscripten/blob/3.1.50/system/include/emscripten/atomic.h) — direct WebAssembly atomic wait/notify contract used to park QEMU vCPU workers at translation-block boundaries on an aligned shared-memory pause word without pthread futex wrapper bookkeeping.
