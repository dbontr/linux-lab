...
async function smokeQemu(page) {
  ...
  await page.locator('[data-boot]').click()
  console.log('QEMU smoke: waiting for prepared x86-64 boot')
  await waitForStatus(page, 'OneDrive bridge attached', 90_000)
  console.log('QEMU smoke: prepared x86-64 boot ready')
  ...
  console.log('QEMU smoke: requesting pause')
  await page.locator('[data-pause]').click()
  await waitForStatus(page, 'is stopped', 10_000)
  console.log('QEMU smoke: pause acknowledged')
  ...
  console.log('QEMU smoke: requesting resume')
  await page.locator('[data-pause]').click()
  await waitForStatus(page, 'is running', 10_000)
  console.log('QEMU smoke: resume acknowledged')
  ...
  console.log('QEMU smoke: sending prepared-guest mount command')
  ...
  console.log('QEMU smoke: mount command acknowledged')

  console.log('QEMU smoke: preparing custom Tiny Core media')
  ...
  await page.locator('[data-boot]').click()
  console.log('QEMU smoke: waiting for custom Tiny Core boot')
  await waitForStatus(page, 'is running', 90_000)
  console.log('QEMU smoke: custom Tiny Core boot ready')
...
try {
  ...
  console.log('Browser smoke: closing Chromium')
  await browser.close()
  console.log('Browser smoke: Chromium closed')
