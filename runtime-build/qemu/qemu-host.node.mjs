...
test('QEMU browser pause breaks generated TB chains cooperatively and preserves guest clocks', () => {
  ...
  assert.doesNotMatch(controlPatchSource, /CF_NO_GOTO_TB|CF_NO_GOTO_PTR|mttcgPath|wasm32Path|TB_EXIT_REQUESTED|cpu->exception_index/)
