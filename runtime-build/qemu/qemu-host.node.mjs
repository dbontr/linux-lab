...
test('QEMU browser pause parks the vCPU at a qemu-wasm dispatcher boundary', () => {
  ...
  assert.doesNotMatch(controlSource, /vm_stop|vm_start|cpu->stop|cpu->stopped|cpu_resume|qemu_cpu_kick/)
  ...
  assert.doesNotMatch(controlPatchSource, /cpuExecPath|mttcg|emscripten_sleep/)
  assert.match(buildSource, /"\$SOURCE_DIR\/tcg\/wasm32\.c"/)
  assert.match(buildSource, /"\$SOURCE_DIR\/tcg\/wasm32\/tcg-target\.c\.inc"/)
