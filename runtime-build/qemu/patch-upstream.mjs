...
const mesonInstall = 'RUN pip3 install meson==1.5.0'
...
if ((source.split(mesonInstall).length - 1) !== 1) {
  throw new Error('Expected one Meson pip install line')
}
...
const patched = source
  ...
  .replace(mesonInstall, 'RUN pip3 install --break-system-packages meson==1.5.0')
